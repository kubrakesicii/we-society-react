          ...
          <div className="entry-header">
            <div className="mb-5">
              ...
              <div className="entry-meta align-items-center">
                ...
                <div class="divider-small mt-4"></div>
                <div className="">                 
                  <a onClick={clapHandler}>
                    <span className="mr-2">
                  ...
                  <a><span className="mr-4" id="clap-cnt"> {article.clapCount} </span></a>

                  <a href="#comment_section">
                  <span className="">
                      <svg width="24" height="24" viewBox="0 0 24 24" class="hp">
