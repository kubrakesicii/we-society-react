      ...
      {isLoading ? (
        ...
        <div className="container mb-5">
          <div className="row mb-3">
            <div className="entry-meta col-12">
              ...
              <a
                onClick={() => {
                  navigate(
                    `/home?categoryId=${props.category.id}&categoryName=${props.category.name}`
                  );
                }}
              >
                {props.category.name}
          ...
          <div
            ...
            id="article-row"
            onClick={() => {
              if (props.isPublished === -1)
                navigate(`/new-article?action=update&updateId=${props.id}`);
              else {
                      ...
                      <img
                        src={`${
                          props.mainImage !== null
                            ? `data:image/jpeg;base64,${props.mainImage}`
            ...
            <div className="p-2">
              {!isSaved ? (
                ...
                <span className="svgIcon svgIcon--star ml-5">
                  <Link
                    data-toggle="modal"
                    data-target={`#save-article-modal-${articleId}`}
                  >
                    <svg
                      width="24"
                      height="24"
            ...
            <div className="p-2">
              {
                ...
                isOwner ? (
                  <div className="entry-meta">
                    <span className="mr-3">
                      <Link
                        to={`/new-article?action=update&updateId=${props.id}`}
                      >
                        <svg
